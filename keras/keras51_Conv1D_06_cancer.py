...
#2. modeling
model = Sequential()
model.add(Conv1D(128, 2, activation='relu', input_shape=(6, 5)))
...
mcp = ModelCheckpoint(
     ...
     filepath= filepath + 'k51_cancer_' + 'd_'+ date + '_'+ 'e_v_'+ filename                      #파일명 날짜, 시간 넣어서 저장하기
 )
...
4/4 [==============================] - 0s 2ms/step - loss: 0.1911 - accuracy: 0.9561
loss:  0.19113954901695251
accuracy:  0.9561403393745422
accuracy score:  0.956140350877193
'''