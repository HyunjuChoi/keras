...
x_train = x_train.reshape(464809, 6, 3, 3)
x_test = x_test.reshape(116203, 6, 3, 3)

# print('x_test: ', x_test)

#2. modeling
model = Sequential()
model.add(Conv2D(30, (3,3), activation='linear',input_shape=(6,3,3), padding='same'))
...
mcp = ModelCheckpoint(
    ...
    filepath= filepath + 'k39_cnn2_fetch_' + 'd_'+ date + '_'+ 'e_v_'+ filename                      #파일명 날짜, 시간 넣어서 저장하기            
)
...
model.save(path + 'keras39_cnn2_save_model_fetch.h5')           
