...
#     # filepath= filepath + 'k51_boston_' + 'd_'+ date + '_'+ 'e_v_'+ filename                      #파일명 날짜, 시간 넣어서 저장하기            
# )
...
# model.save(path + 'keras51_conv1d_save_model_boston.h5')           
...
4/4 [==============================] - 0s 2ms/step - loss: 20.4291 - mae: 2.9994
mse:  20.429113388061523
R2:  0.7662188163905876


<< Conv1D >>
Epoch 00026: early stopping
4/4 [==============================] - 0s 45ms/step - loss: 26.7204 - mae: 3.2537
mse:  26.72040557861328
R2:  0.6942241911477691
