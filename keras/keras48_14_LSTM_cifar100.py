...
from tensorflow.keras.layers import Dense, Flatten, Conv2D, MaxPooling2D, Dropout, AveragePooling2D, LSTM

model = Sequential()
model.add(LSTM(128, activation='relu', input_shape=(32*3, 32 )))
...
#     save_best_only=True,
#     filepath= filepath + 'k48_LSTM_cifar100_' + 'd_'+ date + '_'+ 'e_v_'+ filename 
# )
