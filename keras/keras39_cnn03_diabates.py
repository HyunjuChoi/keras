...
# #2. modeling
model = Sequential()
model.add(Conv2D(64, (2,2), input_shape=(5, 2, 1)))
...
mcp = ModelCheckpoint(
    ...
    filepath= filepath + 'k39_diabates_' + 'd_'+ date + '_'+ 'e_v_'+ filename                      #파일명 날짜, 시간 넣어서 저장하기            
)
...
model.save(path2 + 'keras39_cnn_save_model_diabates.h5')   
