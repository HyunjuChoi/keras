...
from tensorflow.keras.layers import Dense, Flatten, Conv2D, Dropout, MaxPooling2D, AveragePooling2D, LSTM
...
#     save_best_only=True,
#     filepath= filepath + 'k48_LSTM_cifar10_' + 'd_'+ date + '_'+ 'e_v_'+ filename 
# )
