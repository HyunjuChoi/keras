...
from tensorflow.keras.layers import Dense, Input, Flatten, Conv2D, Dropout, MaxPooling2D, AveragePooling2D
...
mcp = ModelCheckpoint(
    ...
    save_best_only=True,
    filepath= filepath + 'k38_dnn_cifar10_' + 'd_'+ date + '_'+ 'e_v_'+ filename 
)
...
313/313 [==============================] - 1s 4ms/step - loss: 1.5108 - acc: 0.4863
loss:  1.5108089447021484
acc:  0.486299991607666
'''