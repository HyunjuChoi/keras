...
model = Sequential()#<넘파이와 텐서플로우 가져오기>
import numpy as np #numpy를 가져오고 줄여서 np라 한다.
import tensorflow as tf #tensorflow를 가져오고 줄여서 tf라 한다.
print(tf.__version__)   # 2.7.4 #tf의 version을 출력한다.
