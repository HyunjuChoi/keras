...
from tensorflow.keras.layers import Conv2D, Dense, Flatten, MaxPooling2D, AveragePooling2D, Dropout, LSTM

model = Sequential()
model.add(LSTM(120, input_shape=(28, 28), activation='relu'))
...
#     save_best_only=True,
#     filepath= filepath + 'k48_LSTM_' + 'd_'+ date + '_'+ 'e_v_'+ filename 
# )

model.compile(loss='sparse_categorical_crossentropy', optimizer='adam', 
              metrics=['acc'])
model.fit(x_train, y_train, epochs=200, verbose=2, batch_size=100, validation_split=0.2, callbacks=[es])
...
313/313 [==============================] - 1s 1ms/step - loss: 0.2280 - acc: 0.9436
loss:  0.22800393402576447
acc:  0.9435999989509583
Accuracy: 94.36%


1/27 << LSTM >>
Epoch 00041: early stopping
313/313 [==============================] - 5s 15ms/step - loss: 2.3010 - acc: 0.1135
loss:  2.3009867668151855
