...
#2. modeling
model = Sequential()
model.add(Conv2D(30, (2,1), activation='linear',input_shape=(13, 1, 1), padding='same'))
model.add(Conv2D(20, (2,1), activation='relu', padding='same'))
...
mcp = ModelCheckpoint(
    ...
    filepath= filepath + 'k39_wine_' + 'd_'+ date + '_'+ 'e_v_'+ filename                      #파일명 날짜, 시간 넣어서 저장하기            
)
...
model.save(path + 'keras39_cnn_save_model_wine.h5')    
