...
#2.modeling
model = Sequential()
model.add(LSTM(30, activation='linear', input_shape=(8,8)))
...
#     filepath= filepath + 'k48_digits_' + 'd_'+ date + '_'+ 'e_v_'+ filename                      #파일명 날짜, 시간 넣어서 저장하기            
# )

model.fit(x_train, y_train, epochs=1000, batch_size=5,
          validation_split=0.2, verbose=1, callbacks=[es])

# model.save(path + 'keras48_LSTM_save_model_digits.h5')   
