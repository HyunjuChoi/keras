...
#2. modeling
model = Sequential()
model.add(Conv2D(128, (3,3), activation='relu', input_shape=(5,3,2), padding='same'))
...
mcp = ModelCheckpoint(
    ...
    filepath= filepath + 'k39_cancer_' + 'd_'+ date + '_'+ 'e_v_'+ filename                      #파일명 날짜, 시간 넣어서 저장하기            
)
...
model.save(path2 + 'keras39_cnn_save_model_cancer.h5')   
