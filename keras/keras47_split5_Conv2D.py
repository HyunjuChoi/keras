...
from tensorflow.keras.layers import Dense, LSTM, GRU, Conv2D,Flatten
...
### feature => 1에서 2로 ! ###
x = x.reshape(96,2,2,1)                             #CNN에 넣어줘야 하므로 4차원으로 변경
...
#2. modeling
model = Sequential()
model.add(Conv2D(128, (2,2), padding='same', input_shape=(2,2,1)))
model.add(Flatten())
