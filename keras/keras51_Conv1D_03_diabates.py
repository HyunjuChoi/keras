...
# #2. modeling
model = Sequential()
model.add(Conv1D(64, 2, input_shape=(5, 2), padding='same'))
...
#     filepath= filepath + 'k51_diabates_' + 'd_'+ date + '_'+ 'e_v_'+ filename                      #파일명 날짜, 시간 넣어서 저장하기            
# )
...
# model.save(path2 + 'keras51_conv1d_save_model_diabates.h5')   
...
5/5 [==============================] - 0s 1ms/step - loss: 3343.2546 - mse: 3343.2546
r2:  0.41327686603281744


1/27 << LSTM >>

Epoch 00953: early stopping
5/5 [==============================] - 0s 1ms/step - loss: 6974.1812 - mse: 6974.1812
r2:  -0.22393102271248888



<< conv 1d>>
Epoch 00374: early stopping
5/5 [==============================] - 0s 37ms/step - loss: 5366.5864 - mse: 5366.5864
r2:  0.058193005938247055
'''