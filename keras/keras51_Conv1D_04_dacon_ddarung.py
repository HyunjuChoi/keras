...
#     filepath= filepath + 'k48_ddarung_' + 'd_'+ date + '_'+ 'e_v_'+ filename                      #파일명 날짜, 시간 넣어서 저장하기            
# )
...
# model.save(path2 + 'keras48_LSTM_save_model_drop_ddarung.h5')    
...
#print(submission)
submission.to_csv(path+'submission_0127_early_minmax_conv1d.csv')
...
13/13 [==============================] - 0s 924us/step - loss: 18905.3789
loss:  18905.37890625
RMSE:  137.4968347273851
R2:  -1.7883722127845263


<< conv 1d>>
13/13 [==============================] - 0s 5ms/step - loss: 7979.9697
loss:  7979.9697265625
RMSE:  89.3306786352918
R2:  -0.17697330231973796
'''
